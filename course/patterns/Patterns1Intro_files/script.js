...
var gDocTable = new Array(
   ...
   new hrefList("slide0004.htm", 1, 9),
   ...
   new hrefList("slide0032.htm", 1, 25),
   new hrefList("slide0034.htm", 1, 26),
   new hrefList("slide0035.htm", 1, 27),
   new hrefList("slide0036.htm", 1, 28),
   new hrefList("slide0018.htm", 1, 29),
   new hrefList("slide0006.htm", 1, 30),
   new hrefList("slide0037.htm", 1, 31),
   new hrefList("slide0038.htm", 1, 32),
   new hrefList("slide0039.htm", 1, 33),
   new hrefList("slide0040.htm", 1, 34),
   new hrefList("slide0041.htm", 1, 35),
   new hrefList("slide0043.htm", 1, 36),
   new hrefList("slide0019.htm", 1, 37),
   new hrefList("slide0009.htm", 1, 38)
);
